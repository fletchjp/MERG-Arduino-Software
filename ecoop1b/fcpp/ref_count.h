...
public:
   ...
   // Added from my ideas (see function.h) because of the CUDA problem.
   //T* unwrap() const { return ptr; }
   // This is not allowed by gcc 600 - violates
   // error: invalid abstract return type ‘fcpp::Fun0Impl<fcpp::impl::OddList<bool> >’
   //T naked() const { return *ptr; }
};
