...
//  NOTE - I had to change "pio_hw_t *pio_hw = cd->pio_hw;"
//                      to "pio_hw_t *pio_hw = (pio_hw_t*)cd->pio_hw;"
//         in many places, so teh ARDUINO compiler would not complain.  
...
{
    pio_hw_t *pio_hw = (pio_hw_t*)cd->pio_hw;
