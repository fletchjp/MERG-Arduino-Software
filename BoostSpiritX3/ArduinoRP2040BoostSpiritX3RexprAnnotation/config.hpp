...
///
/// This is needed for the parser. It has been changed to remove error handling.
/*=============================================================================
...
=============================================================================*/
#if !defined(BOOST_SPIRIT_X3_REXPR_CONFIG_HPP)
#define BOOST_SPIRIT_X3_REXPR_CONFIG_HPP
